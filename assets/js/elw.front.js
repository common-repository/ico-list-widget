/**
 * ICO List Widget - v1.0.0 - 2017-09-16
 * https://wordpress.org
 *
 * Copyright (c) 2017;
 * Licensed GPLv2+
...
var ICOLW = window.ICOLW || {};
var AppView = require('./front/views/app.view');
var IframeView = require('./front/views/iframe.view');
var $ = (typeof window !== "undefined" ? window['jQuery'] : typeof global !== "undefined" ? global['jQuery'] : null);

(function () {

    if (ICOLW.data === null) return;

    var $widgets = $('.rer-elw-widget');

    if (ICOLW.data.iframe) {
        $widgets.each(function (i, el) {
            ...
            new IframeView(Object.assign({}, ICOLW, widgetSettings));
        });
    } else {
        $widgets.each(function (i, el) {
            var widgetSettings = {
            ...
            new AppView(Object.assign({}, ICOLW, widgetSettings));
        });
    }
})();

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./front/views/app.view":9,"./front/views/iframe.view":12}],2:[function(require,module,exports){
'use strict';

var PageableCollection = require('backbone.paginator');

var eventsModel = require('../models/event.model');
...
},{"../models/event.model":3,"backbone.paginator":13}],3:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = Backbone.Model.extend({
    ...
    initialize: function initialize(attributes, options) {
        this.set({
            ...
            timezone: parseInt(attributes.Timezone),
            hot: !!parseInt(attributes.hot)
        });
    }
...
';\n        }\n\n        #'+
((__t=( id ))==null?'':__t)+
' .elw-pagination > li a:hover {\n            background: '+
((__t=( darken(pc, 10) ))==null?'':__t)+
';\n        }\n\n        #'+
((__t=( id ))==null?'':__t)+
' .elw-d-item {\n            color: '+
((__t=( pc ))==null?'':__t)+
...
__p+='\n    <div class="elw-content">\n        <ul class="elw-nav">\n            <li id="elw-tab-live" class="elw-tab">\n                <a href="#elw-live-section" class="elw-tab-link">'+
((__t=( liveLbl ))==null?'':__t)+
'</a>\n            </li>\n            <li id="elw-tab-upcoming" class="elw-tab">\n                <a href="#elw-upcoming-section" class="elw-tab-link">'+
((__t=( upcomingLbl ))==null?'':__t)+
'</a>\n            </li>\n        </ul>\n\n        <div class="elw-section" id="elw-live-section">\n            <div class="live-events"></div>\n        </div>\n        <div class="elw-section" id="elw-upcoming-section">\n            <div class="upcoming-events"></div>\n        </div>\n        ';
 if (poweredBy) { 
__p+='\n            <div class="elw-powered-by">'+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="elw-listing-empty">No events</div>\n';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="elw-event-item">\n    <div class="elw-item-logo">\n        ';
 if (image) { 
__p+='\n            <a href="'+
((__t=( url ))==null?'':__t)+
'" title="'+
...
'" title="'+
((__t=( name))==null?'':__t)+
'" target="_blank">\n                <span class="elw-event-name">\n                    '+
((__t=( name ))==null?'':__t)+
'\n                </span>\n            </a>\n        ';
 } 
__p+='\n        ';
 if (isHot) { 
__p+='\n            <span class="elw-hot-flag">HOT</span>\n        ';
 } 
__p+='\n    </div>\n    <div class="elw-item-desc">\n        '+
((__t=( getExcerpt() ))==null?'':__t)+
'\n    </div>\n    <div class="elw-item-time">\n        ';
 if ('countdown' === s.timerType) { 
__p+='\n            ';
 // Show timer from now until endTime   
__p+='\n            ';
 if ('live' === type) { 
__p+='\n                <div class="elw-c-item">\n                    <div class="elw-c-val">\n                        '+
((__t=( timeUntil(targetTime, tz).days ))==null?'':__t)+
'\n                    </div>\n                    <div class="elw-c-label">Days</div>\n                </div>\n                <div class="elw-c-item">\n                    <div class="elw-c-val">\n                        '+
((__t=( timeUntil(targetTime, tz).hours ))==null?'':__t)+
'\n                    </div>\n                    <div class="elw-c-label">Hours</div>\n                </div>\n                <div class="elw-c-item elw-c-minutes">\n                    <div class="elw-c-val">\n                        '+
((__t=( timeUntil(targetTime, tz).minutes ))==null?'':__t)+
'\n                    </div>\n                    <div class="elw-c-label">Minutes</div>\n                </div>\n            ';
 } else { 
__p+='\n                ';
 // Show timer from now until startTime   
__p+='\n                ';
 if (targetTime.toUpperCase() === 'TBD') { 
__p+='\n                    <div class="elw-c-item">\n                        <div class="elw-c-val">TBD</div>\n                    </div>\n                ';
 } else { 
__p+='\n                    <div class="elw-c-item">\n                        <div class="elw-c-val">\n                            '+
((__t=( timeUntil(targetTime, tz).days ))==null?'':__t)+
'\n                        </div>\n                        <div class="elw-c-label">Days</div>\n                    </div>\n                    <div class="elw-c-item">\n                        <div class="elw-c-val">\n                            '+
...
__p+='\n        ';
 } else if ('date' === s.timerType) { 
__p+='\n            ';
 if ('live' === type) { 
__p+='\n                <div class="elw-d-item elw-d-month">\n                    '+
((__t=( eventDate(targetTime, tz).month ))==null?'':__t)+
'\n                </div>\n                <div class="elw-d-item elw-d-day">\n                    '+
((__t=( eventDate(targetTime, tz).day ))==null?'':__t)+
'\n                </div>\n            ';
 } else { 
__p+='\n                ';
 if (targetTime.toUpperCase() === 'TBD') { 
__p+='\n                    <div class="elw-d-item">\n                        <div class="elw-d-month">TBD</div>\n                    </div>\n                ';
 } else { 
__p+='\n                    <div class="elw-d-item elw-d-month">\n                        '+
((__t=( eventDate(targetTime, tz).month ))==null?'':__t)+
'\n                    </div>\n                    <div class="elw-d-item elw-d-day">\n                        '+
...
__p+='\n        ';
 } else if ('progress' === s.timerType) { 
__p+='\n            ';
 if ('live' === type) { 
__p+='\n                <div class="elw-p-item">\n                    ';
 d = liveEventProgress(); 
__p+='\n                    <div class="elw-p-val">\n                        <div class="elw-p-bar" style="width: '+
((__t=( d ))==null?'':__t)+
'px;"></div>\n                    </div>\n                    <div class="elw-p-label"> '+
((__t=( d ))==null?'':__t)+
'% </div>\n                </div>\n            ';
 } else { 
__p+='\n                ';
...
__p+='\n    </div>\n    <div class="elw-item-action">\n        <div class="elw-item-more">More Details</div>\n    </div>\n</div>\n';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="elw-listing" style="min-height: '+
((__t=( minHeight + 'px;' ))==null?'':__t)+
'"> </div>\n\n<ul class="elw-pagination">\n    ';
 if (p.currentPage > p.firstPage) { 
__p+='\n        <li class="prev">\n            <a href="#"> <span class="elw-arrow dashicons dashicons-arrow-left"></span> </a>\n        </li>\n    ';
 } else { 
__p+='\n        <li class="prev disabled">\n            <span class="elw-arrow dashicons dashicons-arrow-left"></span>\n        </li>\n    ';
 } 
__p+='\n\n    ';
 if (p.currentPage < p.lastPage) { 
__p+='\n        <li class="next">\n            <a href="#">\n                <span class="elw-arrow dashicons dashicons-arrow-right"></span>\n            </a>\n        </li>\n    ';
 } else { 
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="elw-app">\n    ';
 if (title) { 
__p+='\n        <h2 class="elw-title">'+
((__t=( title ))==null?'':__t)+
'</h2>\n    ';
 } 
__p+='\n        <div class="elw-content-iframe" style="height: '+
((__t=( frameHeight + 'px' ))==null?'':__t)+
'">\n            <iframe src="'+
((__t=( buildUrl() ))==null?'':__t)+
...
var appTemplate = require('../templates/app.ejs');
...
module.exports = Backbone.View.extend({
    ...
    // instance of backbone tabs
    tabs: null,
    // instance of live events view
    liveEventsView: null,
    // instance of upcoming events view
    upcomingEventsView: null,
    // instance of live events collection
    liveEventsCollection: null,
    // instance of upcoming events collection
    upcomingEventsCollection: null,
    // widget settings as set in wp admin
    settings: null,

    events: {
        'click #elw-tab-live': 'renderLiveEvents',
        'click #elw-tab-upcoming': 'renderUpcomingEvents'
    },

    /**
     * Initialize view
     * @param params object Data from server
     */
    initialize: function initialize(params) {
        ...
        this.settings = {
            pc: params.color,
            timerType: params.type,
            title: params.title,
            liveLbl: params.labels.live,
            upcomingLbl: params.labels.upcoming,
            pageSize: params.items,
            poweredBy: params.data.powered_by.Text,
            id: params.id,
            tabsAlignment: this.$el.width() > 500 ? 'left' : 'center'
        };

        // Add functions to access in template
        _.extend(this.settings, {
            lighten: this.lightenColor,
            darken: this.darkenColor,
            complement: this.complementColor
        });

        var liveEvents = this.prepareEvents(params.data.events.live, 'live');
        var upcomingEvents = this.prepareEvents(params.data.events.upcoming, 'upcoming');

        this.liveEventsCollection = new eventsCollection(liveEvents, { state: state });
        this.upcomingEventsCollection = new eventsCollection(upcomingEvents, { state: state });

        _.bindAll(this, 'render', 'beforeRender', 'afterRender', 'renderLiveEvents', 'renderUpcomingEvents');
    ...
    renderLiveEvents: function renderLiveEvents() {
        if (this.liveEventsView) {
            this.liveEventsView.render();
        } else {
            this.liveEventsView = new eventsView({
                el: this.$('.live-events'),
                collection: this.liveEventsCollection,
                settings: this.settings
            });
        }
    },

    renderUpcomingEvents: function renderUpcomingEvents() {
        if (this.upcomingEventsView) {
            this.upcomingEventsView.render();
        } else {
            this.upcomingEventsView = new eventsView({
                el: this.$('.upcoming-events'),
                collection: this.upcomingEventsCollection,
                settings: this.settings
            });
        }
    },
    ...
    /**
     * Prepare events data before passing to collection
     * @param events
     * @param type
     *
     * @return array Filtered and ordered models
     * [{
     *      name: string,
     *      image: string,
     *      url: string,
     *      startTime: int, // Time in ms
     *      endTime: int, // Time in ms
     *      targetTime: int, (startTime | endTime) depending of type
     *      tz: int, // Timezone offset
     *      tzOffset: int, // Timezone offset in ms
     *      isHot: boolean,
     *      type: string (live | upcoming)
     * }]
     */
    prepareEvents: function prepareEvents(events, type) {
        var result = events.map(function (ev) {
            var result = {
                ...
                endTime: ev.end_time,
                tz: parseInt(ev.Timezone),
                isHot: !!parseInt(ev.hot),
                description: typeof ev.description === 'undefined' ? '' : ev.description
            };

            switch (type) {
                case 'live':
                    result.targetTime = result.endTime;
                    result.type = 'live';
                    break;
                case 'upcoming':
                    result.targetTime = result.startTime;
        ...
        // Filter events with target date in the past
        result = result.filter(function (ev) {
            if (ev.startTime.toUpperCase() === 'TBD') return true;
            return moment(new Date()).isBefore(ev.targetTime);
        });
        // Order events (hot first, then order by start_time for upcoming or end_time for live)
        /* New requirement -> sorting will be made on the server. Do nothing here
        let hotEvents = result.filter(ev => ev.isHot).sort((a, b) => {
            const at = a.targetTime;
            const bt = b.targetTime;
            if (at.toUpperCase() === 'TBD' || bt.toUpperCase() === 'TBD') return 0;
            return moment(a.targetTime).isBefore(moment(b.targetTime));
        });
        let otherEvents = result.filter(ev => !ev.isHot).sort((a, b) => {
            const at = a.targetTime;
            const bt = b.targetTime;
            if (at.toUpperCase() === 'TBD' || bt.toUpperCase() === 'TBD') return 0;
            return moment(a.targetTime).isBefore(moment(b.targetTime));
        });
         return hotEvents.concat(otherEvents);
        */
        return result;
    },

    lightenColor: function lightenColor(color, amt) {
        return tinycolor(color).lighten(amt).toString();
    },

    darkenColor: function darkenColor(color, amt) {
        return tinycolor(color).darken(amt).toString();
    },

    complementColor: function complementColor(color) {
...
},{"../collections/events.collection":2,"../templates/app.ejs":4,"./events.view":11,"moment":14,"tinycolor2":15}],10:[function(require,module,exports){
(function (global){
'use strict';
...
var template = require('../templates/event.ejs');
...
module.exports = Backbone.View.extend({
    ...
    events: {
        'click .elw-event-item': 'goToEvent'
    },
    ...
    initialize: function initialize(data) {
        ...
        _.bindAll(this, 'render', 'beforeRender', 'afterRender', 'goToEvent', 'liveEventProgress', 'getExcerpt');
    ...
    render: function render() {
        ...
        _.extend(data, {
            ...
            liveEventProgress: this.liveEventProgress,
            getExcerpt: this.getExcerpt
        });

        this.$el.html(this.template(Object.assign({}, this.model.attributes, data)));
        return this;
    },

    afterRender: function afterRender() {},

    eventDate: function eventDate(targetTime, tz) {
        var targetDate = moment(targetTime).utcOffset(tz);

        var month = targetDate.format('MMM');
        var day = targetDate.format('DD');
        var hour = targetDate.format('HH');

        return { month: month, day: day, hour: hour };
    },

    timeUntil: function timeUntil(targetTime, tz) {
        var target = moment.utc(targetTime);
        var now = moment.utc();
        var duration = moment.duration(target.diff(now));

        var sl = duration.asSeconds() - tz * 3600;

        var days = ("0" + parseInt(sl / 86400)).slice(-2);
        sl = sl % 86400;

        var hours = ("0" + parseInt(sl / 3600)).slice(-2);
        sl = sl % 3600;

        var minutes = ("0" + parseInt(sl / 60)).slice(-2);

        return { days: days, hours: hours, minutes: minutes };
    },

    /**
     * How much time passed in relation to total length
     */
    liveEventProgress: function liveEventProgress() {
        var start = moment.utc(this.model.get('startTime'));
        var end = moment.utc(this.model.get('endTime'));
        var duration = moment.duration(moment.utc().diff(start));
        var totalDuration = moment.duration(end.diff(start));
        return Math.floor(duration / totalDuration * 100);
    },

    /**
     * Cut excerpt from event description
     */
    getExcerpt: function getExcerpt() {
        return this.model.get('description');
        /** No need to extract max length
        const desc = this.model.get('description');
        if (!desc) return '';
        let excerpt = desc.substr(0, this.excerptMaxLength);
        return excerpt.substr(0, Math.min(excerpt.length, excerpt.lastIndexOf(' '))) + ' ...';
         */
    },

    goToEvent: function goToEvent(e) {
        e.preventDefault();
        e.stopPropagation();
...
},{"../templates/event.ejs":6,"moment":14,"underscore":16}],11:[function(require,module,exports){
(function (global){
'use strict';
...
var eventsTemplate = require('../templates/events.ejs');
var emptyEventsTemplate = require('../templates/empty-events.ejs');
var eventView = require('./event.view');

module.exports = Backbone.View.extend({

    template: eventsTemplate,
    emptyEventsTemplate: emptyEventsTemplate,

    events: {
        'click li.prev > a': 'goToPrev',
        'click li.next > a': 'goToNext'
    },
    ...
    initialize: function initialize(data) {
        ...
        this.listenTo(this.collection, 'pageable:state:change', this.render);

        // Update view every minute
        if (this.settings.timerType in ['countdown', 'progress']) {
    ...
    beforeRender: function beforeRender() {
        ...
        if (this.collection.length === 0) {
            this.$listing.html(this.emptyEventsTemplate());
        } else {
            this.collection.forEach(function (event) {
                ...
                _this2.$listing.append(ev.render().el);
            });
        }
    },
    ...
    render: function render() {
        var data = {
            'p': this.collection.state,
            'minHeight': 80 * this.settings.pageSize
        };

        this.$el.html(this.template(data));
        this.$('.elw-listing').append(this.$listing);
        return this;
    },
    ...
    afterRender: function afterRender() {
        var minBr = 350;
        var maxBr = 550;
        // hide minutes if container width < 350px
        var width = this.$el.width();
        if (width <= minBr) {
            this.$('.elw-c-minutes').hide();
        }
        if (width <= 450) {
            this.$('.elw-item-action').hide();
        }
        if (width <= maxBr) {
            this.$('.elw-item-desc').hide();
        }
    },
...
},{"../templates/empty-events.ejs":5,"../templates/events.ejs":7,"./event.view":10,"underscore":16}],12:[function(require,module,exports){
(function (global){
'use strict';
...
var iframeTemplate = require('../templates/iframe.ejs');
...
module.exports = Backbone.View.extend({
    ...
    initialize: function initialize(params) {
        ...
        this.settings = {
            ...
            pc: params.color,
            timerType: params.type,
            iframe: params.data.iframe,
            pageSize: params.items,
            poweredBy: params.data.powered_by.Text,
            frameHeight: 45 + 80 * params.items + 45,
            id: params.id
        };

        _.bindAll(this, 'render', 'beforeRender', 'afterRender', 'buildUrl');
    ...
    buildUrl: function buildUrl() {
        return [this.settings.iframe, '?pc=', encodeURIComponent(this.settings.pc), '&pp=', encodeURIComponent(this.settings.pageSize), '&tt=', encodeURIComponent(this.settings.timerType), '&fh=', encodeURIComponent(this.settings.frameHeight)].join('');
    }

});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../templates/iframe.ejs":8}],13:[function(require,module,exports){
(function (global){
/*
  backbone.paginator
...
(function (factory) {
  ...
  if (typeof exports == "object" && typeof require == "function") {
    module.exports = factory(require("underscore"), (typeof window !== "undefined" ? window['Backbone'] : typeof global !== "undefined" ? global['Backbone'] : null));
  }
  // AMD
